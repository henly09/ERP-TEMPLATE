    ...
    <div class="py-12">
        <div class="max-w-10xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <h1 class="text-3xl font-bold pt-4 pb-2 px-4">Create New Voucher Request</h1>
                <h6 class="font-italic px-4"> Fill up this form for the new voucher request....</h6>
                <div class="flex justify-center py-5">
                <form id="createVouch" class="w-full max-w-5xl" action="{{ route('vouchreq.createSave') }}" method="POST">
                @csrf
                        ...
                        <select name="cust_id" id="cust_id" class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" required>
                                <option value="">Select Customer</option>
                                    @foreach ($customers as $customer)
                                        <option value="{{ $customer->id }}" @if (isset($toVouch)) @if ($customer->id == $toVouch->id) selected @endif @endif>
                                            {{ $customer->name }}
                                        </option>
                                    @endforeach
                            </select>
                ...
                <div class="flex justify-center">
                    <div class="flex -mx-3 mb-6 flex-grow">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="particulars" name="particulars" type="text" placeholder="Officia temporibus est corporis." required>
                        </div>
                    </div>
                    <div class="flex -mx-3 mb-6 flex-grow">
                        <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                    ...
                    <div class="flex flex-grow -mx-3 mb-6">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="requested_by"  name="requested_by" type="text" placeholder="Ex. John Doe" required>
                        </div>
                    </div>
                    <div class="flex flex-grow -mx-3 mb-6">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="check_by" name="check_by" placeholder="Ex. Flor De Luna" required>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="flex flex-wrap -mx-3 mb-5 pb-11">
                        ...
                        <textarea id="comments" name="comments" class="appearance-none block w-full h-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="Comments........."> </textarea>
                        </div>
                    </div>
